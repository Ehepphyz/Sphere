...
/**
 * Light theme palette, IntelliJ-style.
 */
public final class ThemePaletteLight implements ThemePalette {

    public static final ThemePaletteLight INSTANCE = new ThemePaletteLight();

    // Base UI colors
    private static final Color BG_MAIN      = new Color(245, 246, 248);
    private static final Color BG_SURFACE   = new Color(255, 255, 255);
    private static final Color BG_TRACK     = new Color(230, 232, 235);
    private static final Color BORDER       = new Color(200, 202, 206);
    private static final Color TEXT_PRIMARY = new Color(40, 42, 46);
    private static final Color TEXT_SECOND  = new Color(110, 112, 116);
    private static final Color ACCENT       = new Color(53, 116, 220);
    private static final Color MOUSE_HOVER  = new Color(70, 73, 78);
    private static final Color BTN_BASE     = new Color(235, 237, 240);
    private static final Color BTN_HOVER    = new Color(220, 222, 226);
    private static final Color BTN_PRESSED  = ACCENT;
    private static final Color SCROLL_THUMB = new Color(180, 182, 186);

    // Additional colors
    private static final Color OVERLAY      = new Color(0, 0, 0, 50);
    private static final Color ERROR        = new Color(200, 60, 60);
    private static final Color SUCCESS      = new Color(60, 150, 60);

    // ConsoleUI colors
    private static final Color TERMINAL_BG        = new Color(250, 250, 250);
    private static final Color TERMINAL_FG        = new Color(30, 30, 30);
    private static final Color TERMINAL_SELECTION = new Color(180, 205, 255);
    private static final Color TERMINAL_BORDER    = new Color(210, 210, 210);

    private static final Color LOG_ERROR_PREFIX   = new Color(220, 60, 60);
    private static final Color LOG_SUCCESS_PREFIX = new Color(40, 160, 80);
    private static final Color LOG_INFO_PREFIX    = new Color(70, 130, 220);
    private static final Color LOG_PROMPT_PREFIX  = new Color(120, 130, 140);
    private static final Color CLEAR_CLEAN_PREFIX   = new Color(145, 155, 165);
    
    private static final Color LOG_WARN_PREFIX    = new Color(200, 150, 20);
    private static final Color LOG_DEBUG_PREFIX   = new Color(120, 90, 165);

    private static final Color LOG_ERROR_TEXT     = new Color(220, 60, 60);
    private static final Color LOG_WARN_TEXT      = new Color(200, 150, 20);
    private static final Color LOG_SUCCESS_TEXT   = new Color(40, 160, 80);
    private static final Color LOG_DEFAULT_TEXT   = new Color(40, 42, 46);

    private static final Color POPUP_BORDER       = new Color(0, 0, 0, 25);
    private static final Color POPUP_BACKGROUND     = new Color(51, 54, 57);
    private static final Color POPUP_HOVER_FALLBACK = new Color(230, 230, 230);
    ...
    private static final Color SCROLL_BORDER     = new Color(210, 210, 210);
    ...
    private static final Color AMBER_ACTIVE_BORDER = new Color(255, 200, 0);
